# quarkus-reactive-mongodb-panache project
...
You can then execute your native executable with: `./target/quarkus-reactive-mongodb-panache-1.0.0-SNAPSHOT-runner`
